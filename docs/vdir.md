# `vdir` — Command Reference

**Source**: [linuxcommand.org](https://linuxcommand.org/lc3_man_pages/vdir1.php)
**Rust module**: `src-tauri/src/commands/vdir.rs`

**Status**: ⚠️ Partial (1/56 flags, 2% complete)
